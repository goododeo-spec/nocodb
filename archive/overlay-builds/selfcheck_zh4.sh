#!/usr/bin/env bash
# Pre-deploy self-check for nocodb-zh:2026.06.1-zh4 against a THROWAWAY postgres.
...
echo "[*] checking GUI is served (the zh4 regression we are guarding against)..."
